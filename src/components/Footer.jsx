...
const Footer = () => {
    return (
        <div className="w-full h-screen bg-zinc-900 flex">
            <div className="w-1/2 font-sans px-8 flex flex-col justify-between h-screen">
                <div className="headings">
                <h1 className="text-9xl -mb-10 font-mono font-extrabold uppercase tracking-tighter">Eye-</h1>
                <h1 className="text-9xl -mb-10 font-mono font-extrabold uppercase tracking-tighter">Opening</h1>
                </div>
                <svg className="mb-8" width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-1/2">
                ...
                <h1 className="uppercase font-mono font-extrabold text-[7vw] tracking-tighter">presentations
                </h1>
                <div className="dets mt-14">
                    <a className="block text-xl font-light" href="#">LinkedIn</a>
                    <a className="block text-xl font-light" href="#">Facebook</a>
                    <a className="block text-xl font-light" href="#">Instagrram</a>
