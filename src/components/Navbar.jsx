...
const Navbar = () => {
    return (
        <div className=" fixed z-50 w-full p-20 py-8 flex items-center justify-between">
            <div className="logo">
                <svg
                    width="72"
                    height="30"
            ...
            <div className="links flex gap-10">
                {["Services", " OurWork" , "About Us", "Insights" ,"Contact Us"].map((item,index)=>(<a key={index} className={`text-lg capitalize font-light ${index===4&&"ml-32"}`}>   
                {item}
                </a>))}
            </div>
        </div>
